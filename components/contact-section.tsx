    ...
    <section id="contact" className="py-28 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary tracking-[0.3em] text-xs font-bold uppercase mb-4">Get In Touch</p>
          ...
          <p className="text-muted-foreground mb-14 max-w-md mx-auto">
            For booking inquiries, press, collaborations, or merchandise — reach out below.
          </p>

          {/* Contact cards */}
          <div className="grid md:grid-cols-2 gap-4 mb-14">
            <div className="p-8 bg-card border border-border hover:border-primary/40 transition-colors duration-300 group text-left">
            ...
            <div className="flex justify-center gap-3">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="flex items-center justify-center w-12 h-12 border border-border bg-card text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-200 hover:scale-110"
                >
                  {social.icon}
                </Link>
              ))}
